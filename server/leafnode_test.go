...
func TestLeafNodeWSBasic(t *testing.T) {
	for _, test := range []struct {
		...
		{"plain no compression", false, false, false},
		{"plain compression", false, true, true},
		{"plain compression disagree", false, false, true},
		{"plain compression disagree 2", false, true, false},
		{"tls no compression", true, false, false},
		{"tls compression", true, true, true},
		{"tls compression disagree", true, false, true},
